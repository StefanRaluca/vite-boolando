        ...
        <div class="container_products">
            <section class="products">
                ...
                <div>
                    ...
                    <span class="price_now">14,99 € </span>
                    <span class="price_before">29,99 €</span>
                </div>
            </section>
        </div>
        <!-- second product  -->
        <div class="container_products">
            <section class="products">
                ...
                <div>
                    <span>Guess</span>
                    <h5>ROSES TEE</h5>
                    <span class="price_now">20,99 € </span>
                    <span class="price_before">29,99 € </span>
                </div>
        ...
        <div class="container_products">
            <section class="products">
                ...
                <div>
                    ...
                    <span class="price_now">12,99 € </span>
                    <span class="price_before">29,99 € </span>
                </div>
            </section>
        </div>
    </div>
    <!-- second section of main bottom -->
    <div class="container_main">
        <!-- first product -->
        <div class="container_products">
            <section class="products">
        ...
        <div class="container_products">
            <section class="products">
                ...
                <div>
                    ...
                    <h5>Stripe Bodice</h5>
                    <span class="price_now">99,99 € </span>
                </div>
        ...
        <div class="container_products">
            <section class="products">
                ...
                <div>
                    ...
                    <span class="price_now">29,99 € </span>
